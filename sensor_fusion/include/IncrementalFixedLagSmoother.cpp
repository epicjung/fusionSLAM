...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::print(const std::string& s,
...
// /* ************************************************************************* */
// bool IncrementalFixedLagSmoother2::equals(const FixedLagSmoother2& rhs,
//     double tol) const {
//   const IncrementalFixedLagSmoother2* e =
//       dynamic_cast<const IncrementalFixedLagSmoother2*>(&rhs);
//   return e != nullptr && FixedLagSmoother2::equals(*e, tol)
//       && isam_.equals(e->isam_, tol);
// }

// /* ************************************************************************* */
// FixedLagSmoother2::Result IncrementalFixedLagSmoother2::update(
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::eraseKeysBefore(double timestamp) {
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::createOrderingConstraints(
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::PrintKeySet(const std::set<Key>& keys,
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::PrintSymbolicFactor(
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::PrintSymbolicGraph(
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::PrintSymbolicTree(const ISAM2& isam,
//     const std::string& label) {
//   std::cout << label << std::endl;
//   if (!isam.roots().empty()) {
...
// /* ************************************************************************* */
// void IncrementalFixedLagSmoother2::PrintSymbolicTreeHelper(
