...
// /* ************************************************************************* */
// void FixedLagSmoother2::Result::print() const {
...
/* ************************************************************************* */
// void FixedLagSmoother2::print(const std::string& s, const KeyFormatter& keyFormatter) const {
//   std::cout << s;
//   std::cout << "  smoother lag: " << smootherLag_ << std::endl;
// }

// /* ************************************************************************* */
// bool FixedLagSmoother2::equals(const FixedLagSmoother2& rhs, double tol) const {
...
// /* ************************************************************************* */
// void FixedLagSmoother2::updateKeyTimestampMap(const KeyTimestampMap& timestamps) {
...
// /* ************************************************************************* */
// void FixedLagSmoother2::eraseKeyTimestampMap(const KeyVector& keys) {
//   for(Key key: keys) {
...
// /* ************************************************************************* */
// double FixedLagSmoother2::getCurrentTimestamp() const {
...
// /* ************************************************************************* */
// KeyVector FixedLagSmoother2::findKeysBefore(double timestamp) const {
//   KeyVector keys;
...
// /* ************************************************************************* */
// KeyVector FixedLagSmoother2::findKeysAfter(double timestamp) const {
//   KeyVector keys;
